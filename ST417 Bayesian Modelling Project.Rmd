...
sim_time <- update(cost_model_jags, 10000)

n <- 10000
sims_time <- coda.samples(cost_model_jags,
  variable.names = c("a", "b", "c", "d", "e", "f", "g", "s"),
  n.iter = n)
```
...
sim_dist <- update(cost_model_jags, 10000)

n <- 10000

sims_dist <- coda.samples(cost_model_jags,
  variable.names = c("a", "b", "c", "d", "e", "f", "g", "s"),
  n.iter = n)
```
