...
From est_time, it appears the data are approximately normally distributed. Therefore, a normal prior will be used, with $mu = $ mean of est_time and $\sigma =$ 

```{r time prior}

prior_time <- rnorm(mean(theta_time), sd(theta_time))
par(mfrow=c(1,1))
