...
- Estimates (to inform priors)
- Data (to inform likelihoods)
...
par(mfrow=c(1,2))
plot(density(est_time), main="Estimated commuting time", xlab="Time (minutes)")
boxplot(est_time, main="Estimated commuting time", xlab="Time (minutes)")
```
